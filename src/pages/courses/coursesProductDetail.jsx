...
const CoursesProductDetail = () => {
  ...
  if (loading) {
    return <div className="pt-header bg-muted text-center p-10">Loading course...</div>;
  }

  if (!id || error) {
    return <div className="pt-header bg-muted text-center p-10 text-destructive">We couldn&apos;t load this course right now.</div>;
  }
