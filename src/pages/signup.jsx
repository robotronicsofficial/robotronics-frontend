...
const RequirementCheck = ({ isValid, text }) => (
  <div className="flex items-center gap-2">
    ...
    >
      {isValid ? <Check className="size-2.5" strokeWidth={4} /> : <X className="size-2.5" strokeWidth={4} />}
    </span>
    <span className={cn("text-caption", isValid ? "text-success" : "text-muted-foreground")}>
      {text}
    </span>
  </div>
);
        ...
        <div className="mx-auto flex w-full max-w-md flex-col gap-6">
          ...
          <div className="flex flex-col gap-4">
            ...
            <div className="flex flex-col gap-1.5">
              ...
              <PhoneInput
                ...
                numberInputProps={{
                  id: "phone",
                  className:
                    "border border-input rounded-md p-2 pl-14 bg-background w-full focus:outline-none focus:ring-2 focus:ring-ring/40 text-base",
                  autoComplete: "tel",
                  type: "tel",
                }}
                countrySelectProps={{
                  className:
                    "absolute left-0 top-0 h-full flex items-center pl-2 touch-manipulation",
                  dropdownClass:
                    "absolute z-dropdown max-h-60 overflow-y-auto bg-card shadow-lg border border-border rounded-md w-60 max-w-full mt-1",
                  buttonClass:
                    "flex items-center justify-center h-full px-2 focus:outline-none",
                }}
            ...
            <Label
              ...
              className="flex cursor-pointer items-start gap-3 text-body-sm font-normal text-muted-foreground"
            >
              <Checkbox
                id="terms-checkbox"
