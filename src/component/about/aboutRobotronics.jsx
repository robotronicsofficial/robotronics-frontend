...
import ceo from "../../assets/imagesContent/aboutceo/ceo.webp"
  ...
  return (
    <div className="flex p-5 flex-col w-full bg-gray">
      ...
      <div className="lg:flex md:flex justify-between lg:p-5">
        ...
        {/* div 2 */}
        <div className="flex-1 px-5 pt-8 lg:pt-14"data-aos="fade-up">
          <AppImage src={ceo} alt="ceo" className="rounded-full " />
        </div>
        {/* div 3 */}
          ...
          <div className="flex flex-col" >
            ...
            <div className="flex justify-end " >
              ...
              <div className=" " data-aos="fade-up">
                <AppImage src={robot} alt="robot" className="h-32" />
              </div>
            </div>
          </div>
        </div>
