...
const AboutRobotronics = () => {
  return (
    <div className="flex p-5 flex-col w-full bg-gray">
      ...
      {/* line */}
      <div className="lg:mx-10"data-aos="fade-up" data-aos-duration="2000" data-aos-delay="4000">
        <div className="h-0 w-full border border-brown"></div>
      </div>
      {/* block 2 */}
      <div className="lg:flex md:flex justify-between lg:p-5">
        {/* row */}
        <div className="flex-1 lg:pt-18 md:pt-10"data-aos="fade-up" data-aos-duration="2000" data-aos-delay="4000">
          {/* col */}
        ...
        {/* div 3 */}
        <div className="flex-1 pt-5 lg:pt-14"data-aos="fade-up" data-aos-duration="2000" data-aos-delay="4000">
          <div className="flex flex-col" >
