...
const CareerJobDetail = () => {
  ...
  return (
    <div className="lg:px-56 px-10 bg-background">
      ...
      <p className="mb-4 poppins-light"data-aos="fade-up" data-aos-duration="2000" data-aos-delay="4000"  >{data.description}</p>

      <h2 className="text-xl poppins-bold font-bold mb-2"data-aos="fade-up" data-aos-duration="2000" data-aos-delay="4000"  >Role Overview:</h2>
      <p className="mb-4"data-aos="fade-up" data-aos-duration="2000" data-aos-delay="4000"  >{data.roleOverview}</p>

      <h2 className="text-xl poppins-bold mb-2"data-aos="fade-up" data-aos-duration="2000" data-aos-delay="4000"  >Key Responsibilities:</h2>
      ...
      <h2 className="text-xl poppins-bold mb-2"data-aos="fade-up" data-aos-duration="2000" data-aos-delay="4000"  >Required Skills:</h2>
      <ul className="list-disc poppins-light list-inside mb-4"data-aos="fade-up" data-aos-duration="2000" data-aos-delay="4000"  >
      ...
      <div className="lg:pb-20 pb-10"data-aos="fade-up" data-aos-duration="2000" data-aos-delay="4000"  >
        {/* text */}
        <div className="lg:py-20 py-10"data-aos="fade-up" data-aos-duration="2000" data-aos-delay="4000"  >
          <p className="text-wrap text-brown poppins-medium lg:text-2xl text-xl mb-10"data-aos="fade-up" data-aos-duration="2000" data-aos-delay="4000"  >
            Jumpstart your journey with Artistsweb by sending your CV, portfolio
            by using the link below.
          </p>
          <p className="text-wrap text-brown poppins-medium lg:text-2xl text-xl"data-aos="fade-up" data-aos-duration="2000" data-aos-delay="4000"  >
