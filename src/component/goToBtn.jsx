const BoToBtn = () => {
  ...
  return (
    ...
    //   <button className="lg:h-20 lg:w-10 border-4 border-gold rounded-3xl fixed bottom-40 right-10 z-floating flex justify-center items-center cursor-pointer ">
    ...
    // </div>
    <div className="flex justify-center align-center" onClick={goToTop}>
      <button className="h-16 w-8 lg:h-20 lg:w-10 border-4 border-gold rounded-3xl fixed bottom-10 lg:bottom-40 right-5 lg:right-10 z-floating flex justify-center items-center cursor-pointer">
