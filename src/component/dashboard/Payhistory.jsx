        ...
        {invoices.map((invoice, index) => (
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-4 sm:gap-6">
              ...
              <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-3 sm:gap-4 md:gap-6 w-full flex md:justify-between flex-col md:flex-row ">
                ...
                <div className="break-words">
                  ...
                  <p className="text-xs sm:text-sm md:text-base md:mr-4">{invoice.service}</p>
                </div>
                <div className="break-words">
