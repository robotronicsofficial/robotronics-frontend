    ...
    <div className="p-5">
      ...
      <div className="p-2">
        <div className="relative w-full h-0 border border-black">
          ...
          <div className="absolute left-2/3 top-1/2 transform -translate-x-1/2 -translate-y-1/2 w-4 h-4 bg-black rounded-full"></div>
      ...
      <div className="lg:flex flex-row p-2 justify-between ">
        ...
        <div className="justify-center">
          ...
          />
          <div className="flex flex-col" >
            <p className="lg:text-xl text-l text-center">CUSTOMER INFORMATION</p>
            <p className="text-sm text-center text-wrap">
              Add your name, phone <br/> number and address.
            </p>
          </div>
